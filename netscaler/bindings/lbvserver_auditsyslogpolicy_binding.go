...
func key_lbvserver_auditsyslogpolicy_binding(d *schema.ResourceData) nitro.LbvserverAuditsyslogpolicyBindingKey {
...
func get_lbvserver_auditsyslogpolicy_binding(d *schema.ResourceData) nitro.LbvserverAuditsyslogpolicyBinding {
	var _ = utils.Convert_set_to_string_array

	resource := nitro.LbvserverAuditsyslogpolicyBinding{
...
func create_lbvserver_auditsyslogpolicy_binding(d *schema.ResourceData, meta interface{}) error {
	...
	key := key_lbvserver_auditsyslogpolicy_binding(d)
	...
	if exists {
		resource, err := client.GetLbvserverAuditsyslogpolicyBinding(key)
		...
		set_lbvserver_auditsyslogpolicy_binding(d, resource)
	} else {
		err := client.AddLbvserverAuditsyslogpolicyBinding(get_lbvserver_auditsyslogpolicy_binding(d))
