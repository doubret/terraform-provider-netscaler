...
func get_lbvserver_transformpolicy_binding(d *schema.ResourceData) nitro.LbvserverTransformpolicyBinding {
...
func get_lbvserver_transformpolicy_binding_key(d *schema.ResourceData) nitro.LbvserverTransformpolicyBindingKey {

	key := nitro.LbvserverTransformpolicyBindingKey{
		d.Get("name").(string),
...
func create_lbvserver_transformpolicy_binding(d *schema.ResourceData, meta interface{}) error {
	...
	resource := get_lbvserver_transformpolicy_binding(d)
	key := resource.ToKey()
	...
	if exists {
		resource, err := client.GetLbvserverTransformpolicyBinding(key)
		...
		set_lbvserver_transformpolicy_binding(d, resource)
	} else {
		err := client.AddLbvserverTransformpolicyBinding(get_lbvserver_transformpolicy_binding(d))
