...
func NetscalerLbvserverResponderpolicyBinding() *schema.Resource {
	return &schema.Resource{
		SchemaVersion: 1,
		Create:        create_lbvserver_responderpolicy_binding,
		Read:          read_lbvserver_responderpolicy_binding,
		Update:        nil,
		Delete:        delete_lbvserver_responderpolicy_binding,
...
func get_lbvserver_responderpolicy_binding_key(d *schema.ResourceData) nitro.LbvserverResponderpolicyBindingKey {
...
func create_lbvserver_responderpolicy_binding(d *schema.ResourceData, meta interface{}) error {
	...
	resource := get_lbvserver_responderpolicy_binding(d)
	key := resource.ToKey()
